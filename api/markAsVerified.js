...
module.exports = async (req, res) => {
    ...
    try {
        ...
        // ETAPA 3: Atualizar a etapa (stage) do negócio
        ...
        return res.status(200).json({ success: true, message: 'Pedido marcado como verificado com sucesso!' });

    } catch (error) {
        console.error('Erro ao marcar pedido como verificado:', error.response ? error.response.data : error.message);
