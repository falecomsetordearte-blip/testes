...
module.exports = async (req, res) => {
    ...
    try {
        ...
        // Usamos LIKE para encontrar o token dentro da string de tokens
        const empresas = await prisma.$queryRawUnsafe(`
            SELECT nome_fantasia, cnpj, whatsapp, email, responsavel, logo_id, saldo 
            FROM empresas 
        ...
        // 2. Retornar os dados da empresa (ID 4 - Visiva, por exemplo)
