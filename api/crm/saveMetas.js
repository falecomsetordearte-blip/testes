...
module.exports = async (req, res) => {
    ...
    try {
        const { 
            sessionToken, mes_ano, meta_mensal, premio_mensal, ajuste_mes,
        ...
        await prisma.$executeRawUnsafe(`
            INSERT INTO crm_metas (
                empresa_id, mes_ano, meta_mensal, premio_mensal, ajuste_mes,
                meta_sem_1, premio_sem_1, sem_1_inicio, sem_1_fim, ajuste_sem_1,
                meta_sem_2, premio_sem_2, sem_2_inicio, sem_2_fim, ajuste_sem_2,
                meta_sem_3, premio_sem_3, sem_3_inicio, sem_3_fim, ajuste_sem_3,
                meta_sem_4, premio_sem_4, sem_4_inicio, sem_4_fim, ajuste_sem_4,
                ...
                $16, $17, $18::date, $19::date, $20,
                $21, $22, $23::date, $24::date, $25,
                NOW()
            )
            ON CONFLICT (empresa_id, mes_ano) 
            DO UPDATE SET 
                meta_mensal = EXCLUDED.meta_mensal, premio_mensal = EXCLUDED.premio_mensal, ajuste_mes = EXCLUDED.ajuste_mes,
                ...
                updated_at = NOW()
        `, empresaId, mes_ano, parseFloat(meta_mensal||0), premio_mensal, parseFloat(ajuste_mes||0),
