...
module.exports = async (req, res) => {
    ...
    try {
        ...
        // Busca Usuários + nome do cargo
        const painelUsuarios = await prisma.$queryRawUnsafe(`
            SELECT u.id, u.nome, u.email, u.ativo, u.funcao_id, f.nome as role_nome
        ...
        // Prepara resposta
        const resposta = painelUsuarios.map(u => ({
            id: u.id,
            nome: u.nome,
            email: u.email,
            ativo: u.ativo,
            funcao_id: u.funcao_id,
            funcao: { nome: u.role_nome }
        }));
