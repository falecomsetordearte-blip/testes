...
module.exports = async (req, res) => {
    ...
    try {
        ...
        const materiais = await prisma.$queryRawUnsafe(`
            SELECT id, nome, ativo FROM materiais WHERE empresa_id = $1 AND ativo = true
            ORDER BY nome ASC
        `, empresaId);
        ...
        console.error("Erro GET listar_materiais:", error);
