...
module.exports = async (req, res) => {
    ...
    try {
        ...
        await prisma.$executeRawUnsafe(`
            INSERT INTO materiais (empresa_id, nome, ativo, criado_em)
            VALUES ($1, $2, true, NOW())
        `, empresaId, nome.trim());

        return res.status(200).json({ message: "Material criado com sucesso!" });

    } catch (error) {
        console.error("Erro POST adicionar_material:", error);
