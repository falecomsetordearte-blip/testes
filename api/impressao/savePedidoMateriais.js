...
module.exports = async (req, res) => {
    ...
    try {
        const { sessionToken, dealId, materiaisIds } = req.body;
        ...
        const arrayToSave = Array.isArray(materiaisIds) ? materiaisIds : [];
        ...
        console.error("Erro POST savePedidoMateriais:", error);
