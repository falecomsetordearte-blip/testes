// /instalacao-loja/painel-script.js - VERSÃO CLEAN (VISUAL ACABAMENTO)
...
(function() {
    document.addEventListener('DOMContentLoaded', () => {
        ...
        // --- ESTILOS VISUAIS (BASEADO NO ACABAMENTO - TEMA ROXO) ---
        const style = document.createElement('style');
        style.textContent = `
            :root {
                --primary: #9b59b6; /* Roxo Loja */
                --success: #2ecc71;
                --danger: #e74c3c;
                --text-dark: #2c3e50;
                --text-light: #7f8c8d;
            ...
            .kanban-card { 
                ...
                border-left: 5px solid var(--primary); /* Roxo */
            ...
            .btn-acao-modal.principal:hover { background-color: #8e44ad; }
            ...
            .spinner { border: 3px solid rgba(155, 89, 182, 0.3); border-top: 3px solid var(--primary); border-radius: 50%; width: 24px; height: 24px; animation: spin 1s linear infinite; margin: 0 auto 10px; }
        ...
        function openDetailsModal(dealId) {
            ...
            modalTitle.textContent = `Instalação na Loja #${deal.TITLE || deal.ID}`;
