...
(function() {
    document.addEventListener('DOMContentLoaded', () => {
            ...
            try {
                ...
                if (messages.length > 0) {
                    chatContainer.innerHTML = messages.map(msg => {
                        ...
                        // Ignora mensagens que ficaram vazias após a limpeza
        ...
        function openDetailsModal(dealId) {
            ...
            if (deal.TITLE) actionsHtml += `<a href="https://setordearte.com.br/pedidos/detalhe?id=${encodeURIComponent(deal.ID)}" target="_blank" class="btn-acao-modal secundario">Ver Pedido do Cliente</a>`;
