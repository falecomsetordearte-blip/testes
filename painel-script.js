...
(function() {
    document.addEventListener('DOMContentLoaded', () => {
        ...
        style.textContent = `
            ...
            .btn-card { flex: 1; padding: 6px; border-radius: 4px; border: none; font-size: 0.8rem; font-weight: 600; cursor: pointer; text-decoration: none; text-align: center; display: flex; align-items: center; justify-content: center; gap: 5px; color: white; }
        ...
        window.atualizarStatusArte = async function(dealId, action) {
            if(!confirm(action === 'APROVADO' ? 'Aprovar arte e enviar para Impressão?' : 'Mover para Ajustes?')) return;
